...
<div id="main">
    <div id="contents">
        ...
        <table>
            <thead>
            <tr>
                <th class="col0">Событие</th>
                <th class="col1">data1</th>
                <th class="col2">data2</th>
                <th class="col3">data3</th>
            </tr>
            </thead>
            <tr>
                <td class="col0">ENTERQUEUE</td>
                <td class="col1"></td>
                <td class="col2">callerid</td>
                <td class="col3">Позиция входа</td>
            </tr>
            <tr>
                <td class="col0">CONNECT</td>
                <td class="col1">Время ожидания</td>
                <td class="col2">uniqueid</td>
                <td class="col3"></td>
            </tr>
            <tr>
                <td class="col0">COMPLETEAGENT, COMPLETECALLER</td>
                <td class="col1">Время ожидания до ответа</td>
                <td class="col2">Продолжительность вызова</td>
                <td class="col3">Позиция при соединении</td>
            </tr>
            <tr>
                <td class="col0">RINGNOANSWER</td>
                <td class="col1">Время вызова агента (Agent Timeout)</td>
                <td class="col2"></td>
                <td class="col3"></td>
            </tr>
            <tr>
                <td class="col0">ABANDON</td>
                <td class="col1">Позиция выхода</td>
                <td class="col2">Позиция входа</td>
                <td class="col3">Время ожидания</td>
            </tr>
            <tr>
                <td class="col0">EXITWITHTIMEOUT</td>
                <td class="col1">Позиция выхода</td>
                <td class="col2">Позиция входа</td>
                <td class="col3">Таймаут очереди</td>
            </tr>
        </table>
        <br/>
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" id="frm1" name="frm1" method="post">
            &nbsp;&nbsp;&nbsp;<input type="checkbox" name="ringnoanswer" value="RINGNOANSWER"
                                     checked>&nbsp;<?php echo $lang["$language"]['hidden_ringnoanswer']; ?>
            &nbsp;&nbsp;&nbsp;<input type="checkbox" name="alltime"
                                     value="alltime">&nbsp;<?php echo "Искать за все время"; ?><br/><br/>
        ...
        <TABLE width='99%' cellpadding=1 cellspacing=1 border=0 class='sortable' id='tableraw'>
            ...
            foreach ($result as $row) {
			   ...
			   ';
                ...
                $rec['path'] = '/var/spool/asterisk/monitor/' . $rec['filename'];
