...
$query = "SELECT time, queuename, agent, event, data1, data2, data3 FROM $DBTable WHERE time >= '$start' AND time <= '$end' AND event IN ('COMPLETECALLER', 'COMPLETEAGENT') AND queuename IN ($queue) AND agent in ($agent)";
...
<div id="main">
            ...
            <TR>
                ...
                <TD valign=top width='50%'>
                    ...
                    <TABLE width='100%' border=0 cellpadding=0 cellspacing=0>
                        ...
                        <TR>
                            <TD><?php echo $lang["$language"]['total'] ?> <?php echo $lang["$language"]['calltime'] ?>
                                :
                            </TD>
                ...
                <TD align=center bgcolor='#ffffff' width='50%'>
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            ...
                            var chart = new google.charts.Bar(document.getElementById("dur_by_agent"));
	...
	<td>" . $total26 . "</td>
        ...
        <td align=center bgcolor='#ffffff'>
            ...
            <div id="piechart" style="height: 210px;"></div>
