...
$sql = "select calldate, uniqueid, billsec, disposition, outbound_cnum, cnum, dst_cnam, recordingfile, src, dst, linkedid, recordingfile, clid, cnam from cdr where calldate >= '$start' AND calldate <= '$end' AND LENGTH(outbound_cnum) >= 4 AND lastapp != 'Hangup';";
