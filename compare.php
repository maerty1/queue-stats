...
$head_q = array('Очереди', 'Всего', 'Отвеченные', 'Пропущенные');
...
<head>
    ...
    <script type="text/javascript">
        ...
        function drawTableQueue() {
            ...
            data.addColumn('number', 'Отвеченные');
            data.addColumn('number', 'Пропущенные');
            data.addColumn('string', 'Процент пропущенных');
            data.addRows(
...
<div id="main">
    <div id="contents">
        ...
        <div id="columnchart_queue" style="width: auto; height: 400px;"></div>
        <br/>
