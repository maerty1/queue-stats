...
<div id="main">
    <div id="contents">
            ...
            <TR>
                <TD valign=top width='50%'>
                    <TABLE width='100%' border=0 cellpadding=0 cellspacing=0>
                        ...
                        <TD><?php echo $start_parts ?></TD>
                        </TR>
                        </TR>
                        <TR>
                            <TD><?php echo $lang["$language"]['end'] ?>:</TD>
                            <TD><?php echo $end_parts ?></TD>
                        </TR>
                        <TR>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" id="frm1" name="frm1" method="post">
            &nbsp;&nbsp;&nbsp;<input type="checkbox" name="ringnoanswer"
                                     value="RINGNOANSWER">&nbsp;<?php echo $lang["$language"]['hidden_ringnoanswer']; ?>
            <br/><br/>
            ...
            &nbsp;&nbsp;&nbsp;<b><?php echo $lang["$language"]['page_rows']; ?></b>&nbsp;<select id="pagerows"
                                                                                                 name="pagerows"/>
