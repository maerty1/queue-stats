...
$start_dayb1 = date('Y-m-d 00:00:00', strtotime("-1 day")); // from yesterday 10:00
$end_dayb1 = date('Y-m-d 23:59:59'); // to today 10:00
    ...
    <div id="contents">
        ...
        <form method=POST action='answered.php'>
                ...
                <table border="0" cellspacing="0" cellpadding="8">
                    <tr>
                        <td>
                            ...
                            <select name="List_Queue_available" multiple="multiple" id="myform_List_Queue_from" size=10
                                    style="height: 100px;width: 125px;"
                                    onDblClick="List_move_around('right',false,'queues');">
                                <?php
                        ...
                        <td align="left">
                            <a href='#' onclick="List_move_around('right',false,'queues'); return false;"><img
                                        src='images/go-next.png' width=16 height=16 border=0></a>
                            <a href='#' onclick="List_move_around('left', false,'queues'); return false;"><img
                                        src='images/go-previous.png' width=16 height=16 border=0></a>
                            <br>
                            <br>
                            <a href='#' onclick="List_move_around('right', true,'queues'); return false;"><img
                                        src='images/go-last.png' width=16 height=16 border=0></a>
                            <a href='#' onclick="List_move_around('left', true,'queues'); return false;"><img
                                        src='images/go-first.png' width=16 height=16 border=0></a>
                        </td>
                        <td>
                            <?php echo $lang["$language"]['selected'] ?><BR>
                            <select size=10 name="List_Queue[]" multiple="multiple" style="height: 100px;width: 125px;"
                                    id="myform_List_Queue_to" onDblClick="List_move_around('left',false,'queues');">
                                <?php
            ...
            <div id='right'>
                ...
                <table border="0" cellspacing="0" cellpadding="8">
                    <tr>
                        <td>
                            <?php echo $lang["$language"]['available'] ?><BR>
                            <select size=10 name="List_Agent_available" multiple="multiple" id="myform_List_Agent_from"
                                    style="height: 100px;width: 125px;"
                                    onDblClick="List_move_around('right',false,'agents');">
                                <?php
                        ...
                        <td align="left">
                            <a href='#' onclick="List_move_around('right',false,'agents'); return false;"><img
                                        src='images/go-next.png' width=16 height=16 border=0></a>
                            <a href='#' onclick="List_move_around('left', false,'agents'); return false;"><img
                                        src='images/go-previous.png' width=16 height=16 border=0></a>
                            <br>
                            <br>
                            <a href='#' onclick="List_move_around('right', true,'agents'); return false;"><img
                                        src='images/go-last.png' width=16 height=16 border=0></a>
                            <a href='#' onclick="List_move_around('left', true,'agents'); return false;"><img
                                        src='images/go-first.png' width=16 height=16 border=0></a>
                        </td>
                        <td>
                            <?php echo $lang["$language"]['selected'] ?><BR>
                            <select size=10 name="List_Agent[]" multiple="multiple" style="height: 100px;width: 125px;"
                                    id="myform_List_Agent_to" onDblClick="List_move_around('left',false,'agents');">
                                <?php
                                if ($agent == "''") {
                                    foreach ($agentes as $agentel) {
                                        if ($agentel != "NONE") {
            ...
            <div id='rest'>
                ...
                echo "<a href=\"javascript:setdates('$begin_past2_month', '$end_month')\">" . $lang["$language"]['last_three_months'] . "</a>";
                //
